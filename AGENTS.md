...
- 修改共享规则前审计所有可发现消费项目的根规则、专项规则和冲突。用户明确要求新增、纠正、优化、删除或沉淀共享规则时，已授权提交、语义化版本 tag、推送本仓库，并更新、提交和推送各消费项目必要的 overlay/gitlink；不授权夹带其他脏改、发布产品或运行 Unity 验证。
- 同一逻辑变更同步维护 instruction、README 和 CHANGELOG；删除重复或过时正文，不保留新旧双轨。
